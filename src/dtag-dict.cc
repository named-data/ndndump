...
static const struct ccn_dict_entry ccn_tagdict[] = {
    ...
    {ns3::CcnbParser::DTAG_NdnldConnection, "NdnldConnection"},
    {ns3::CcnbParser::DTAG_NdnldLowerProtocol, "NdnldLowerProtocol"},
    {ns3::CcnbParser::DTAG_NdnldLocalInterface, "NdnldLocalInterface"},
    {ns3::CcnbParser::DTAG_NdnldSentPktsCapacity, "NdnldSentPktsCapacity"},
    {ns3::CcnbParser::DTAG_NdnldRetransmitCount, "NdnldRetransmitCount"},
    {ns3::CcnbParser::DTAG_NdnldRetransmitTime, "NdnldRetransmitCount"},
    {ns3::CcnbParser::DTAG_NdnldAcknowledgeTime, "NdnldRetransmitCount"},

    {ns3::CcnbParser::NdnlpData, "NdnlpData"},
    {ns3::CcnbParser::NdnlpSequence, "NdnlpSequence"},
    {ns3::CcnbParser::NdnlpFlags, "NdnlpFlags"},
    {ns3::CcnbParser::NdnlpFragIndex, "NdnlpFragIndex"},
    {ns3::CcnbParser::NdnlpFragCount, "NdnlpFragCount"},
    {ns3::CcnbParser::NdnlpPayload, "NdnlpPayload"},
    {ns3::CcnbParser::NdnlpAck, "NdnlpAck"},
    {ns3::CcnbParser::NdnlpAckBlock, "NdnlpAckBlock"},
    {ns3::CcnbParser::NdnlpSequenceBase, "NdnlpSequenceBase"},
    {ns3::CcnbParser::NdnlpBitmap, "NdnlpBitmap"},

    {0, 0}
};

struct ccn_dict ccn_dtag_dict2 = {ARRAY_N(ccn_tagdict) - 1, ccn_tagdict};
